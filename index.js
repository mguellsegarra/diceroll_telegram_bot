...
bot.onText(/^\/start$/g, function onPhotoText(msg) {
...
bot.onText(/^\/help$/g, function onPhotoText(msg) {
    sendMessage(msg.chat.id, currentLocale.playCommands.join("\n"))
        .catch(logError);
});

bot.onText(/^\/info$/g, function onPhotoText(msg) {
    sendMessage(msg.chat.id, currentLocale.info.join(""))
        .catch(logError);
});

bot.onText(/^\/roll$/g, function onPhotoText(msg) {
...
bot.onText(/^\/rollhuge$/g, function onPhotoText(msg) {
